...
Enhver **skriftlig innlevering** (utfordring) kan gi 0 til 3 poeng. Enhver **flervalgstest** kan gi 0 til 2 poeng. Totalt kan altså innleveringene gi 15 poeng. Karakteren på mappen avhenger total poeng på alle innleveringer. 
...
Alle spørsmål på flervalgtestene på sok-2303 har fire svaralternativer hvorav bare ett er riktig.  

## Utfordringer (innlevering 2, 4, og 5)
Hver utfordring vil ha flere deloppgaver. Noen av oppgavene er matematiske, andre er mer rettet mot diskusjon, og i noen av dem skal dere bruke data og enklere statistisk analyse. 
For alle oppgaver gjelder at dere må gi økonomisk intuisjon til deres svar dvs. sammenhengene på samfunnsøkponomiske mekanismer bak deres resultater klargjøres og forklares. 

### Innlevering av utfordringer
Innleveringene gjennomføres i grupper om 1-3 personer. For å få kontroll og unngå problemer, ønsker vi at alle gruppemedlemmer leverer inn oppgaven. 
...
**NB: Det er utrolig viktig at dere bruker følgende navn på deres innlevering! "[kandidatnummer]sok_2303_v26_utf[utfordringsnummer]"**
...
Det er tillatt å arbeide med oppgavene sammen med andre.
Det er ikke lov å kopiere figurer fra forelesningsnotater. Alle kilder utenfor pensum skal ha riktig kildehenvisning. 

### Bruk av kunstig intelligens (KI)
Det er lov å bruke KI som hjelpe-verktøy i arbeidet med utfordringene. Det er likevel dere som skal skrive oppgavene og dere er selve ansvarlige for innholdet i oppgavene deres.
Hver innlevering **skal** inneholde en KI-deklarasjon. **Du må ha med deklarasjonen selv om du ikke har brukt KI**.

**Dersom du ikke gjør rede for ditt bruk av KI, vil oppdekket bruk anses som juks**. 
...
#### Figurer og grafer
Det går an å lage figurer ved bruk av en rekke verktøy. I utfordringer der dere blir bedt om å grafisk analysere teoretiske mekanismer (f.eks. hvordan et individ velger mellom konsum og fritid), skal dere levere inn 2 figurer: en som dere har tegnet for hånd og fotet av, og en som dere har tegnet ved bruk av et verktøy.  f.eks RStudio og Python. 
Mange bruker Python eller R-studio til å lage figurer, men det er også mulig å tegne figurer i ved bruk av andre verktøy, f.eks Krita, Adobe illustrator, Word eller Power-point.
